#include "Game\Battle\Battle_Animation.h"

Battle_Animation::Battle_Animation(short numFrames, short frameDelay, short finalFrameDelay, short initialFrameDelay, short startLoopFrame, short finalLoopFrame,
